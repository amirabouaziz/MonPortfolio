    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Divider(//pour séparer le titre du contenu principal.
            color: Theme.of(context).canvasColor,
          ),
          Expanded(
            child: ListView.separated(//pour afficher la liste des expériences professionnelles de l'utilisateur avec une séparation entre chaque élément.
              padding: EdgeInsets.all(10),
